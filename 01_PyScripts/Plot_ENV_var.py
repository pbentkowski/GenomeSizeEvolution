...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep 15 14:23:00 2010
...
Mean_Var = np.genfromtxt("ENV_variance.dat")
tags = np.genfromtxt("ENV_TAGS_variance.dat")
All_the_frames = np.genfromtxt("ENV_All_the_frames.dat")
...
p.xlabel('frame size')
p.ylabel('mean variance of the environment')
p.grid(True)
