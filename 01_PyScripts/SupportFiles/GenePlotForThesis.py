...
p.figure(1, figsize=(1000,800))
p.plot(x,y,'b-', linewidth=2)
p.xlabel('environmental conditions [ $x$ ]', fontsize=FontSize)
p.ylabel('efficiemcy of resource uptake [ $u(x,c,\sigma,A)$ ]', fontsize=FontSize)
p.text(0.25, 0.85, r"$u(x,c,\sigma,A)= A e^{\frac{-(x-c)^2}{2\sigma^2}} $", fontsize=26)
